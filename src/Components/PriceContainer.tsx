    ...
    return (
        <div className='flex flex-col h-1/5 bg-slate-100 rounded-sm w-full shadow border border-stone-300'>
            ...
            <div className='flex justify-center w-full h-2/3 relative'>
                <div className='w-1/2 text-center  md:text-xl text-slate-600'>{currency.buy}</div>
                <div className='w-1/2 text-center md:text-xl text-slate-600 border-l border-stone-300'>{currency.sell}</div>
